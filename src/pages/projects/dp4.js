  ...
  return (
    <Layout title="Design Portfolio 4">
      <Container>
        ...
        <Paragraph>
          My main contributions to this project were designing the user interface and linking all parts of the project together into a cohesive, deployable application.
        </Paragraph>
